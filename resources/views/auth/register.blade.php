<x-layout>
    ...
    <div class="m-0 bg-white sm:rounded-lg flex justify-center flex-1 relative">
        <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 relative">

            <div class="flex flex-col items-center mt-20 relative">
                <a href="/"
                    class="absolute top-0 left-[-50%] flex items-center text-blue-500 border border-gray-200 rounded-[8px] h-[48px] px-2 hover:bg-gray-200">
                ...
                <p class="text-gray-500 text-center mt-2">
                    Sign up to access unlimited materials, exclusive services, and more.
                </p>
                <form method="POST" action="{{ route('register') }}" class="w-full flex-1 mt-8">
                    ...
                    <div class="mx-auto max-w-xs">
                        ...
                        <span class="text-xs text-gray-600 text-center">Have an account? <a href="/login"
                                class="text-blue-600 underline">Login</a> to your account</span>
